...
{
    public struct SelectManyEnumeratorH<TSource, TCollection, TResult, TEnumerator1, TCollectionSelector, TResultSelector> : IEnumerator<TResult>
        ...
        where TResultSelector : IFunctor<TSource, TCollection, TResult>
    {
        ...
        public SelectManyEnumeratorH(TEnumerator1 source, TCollectionSelector collectionSelector, TResultSelector resultSelector)
        {
            this.source = source;
