...
{
    public struct SelectManyEnumeratorE<TSource, TCollection, TResult, TEnumerator1, TEnumerator2, TCollectionSelector, TResultSelector> : IEnumerator<TResult>
        ...
        where TResultSelector : IFunctor<TSource, TCollection, TResult>
    {
        ...
        public SelectManyEnumeratorE(TEnumerator1 source, TCollectionSelector collectionSelector, TResultSelector resultSelector)
        {
            this.source = source;
