...
{
    public struct SelectManyEnumeratorA<TSource, TResult, TEnumerator1, TEnumerator2, TSelector> : IEnumerator<TResult>
        ...
        where TSelector : IFunctor<TSource, IEnumerable<TResult, TEnumerator2>>
    {
        ...
        public SelectManyEnumeratorA(TEnumerator1 source, TSelector selector)
        {
            this.source = source;
